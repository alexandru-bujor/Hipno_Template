...
const Testimonials = () => {
  ...
  const customerImages = [
    ...
    getAssetPath('assets/images/hero-images/AdobeStock_1013238345.jpeg'),
    getAssetPath('assets/images/hero-images/AdobeStock_1649580010.jpeg'),
    getAssetPath('assets/images/hero-images/AdobeStock_183593206.jpeg')
  ]

  const companyLogos = [
    getAssetPath('assets/images/company-logo-1.svg'),
    getAssetPath('assets/images/company-logo-2.svg'),
    getAssetPath('assets/images/company-logo-3.svg'),
    getAssetPath('assets/images/company-logo-4.svg'),
    getAssetPath('assets/images/company-logo-5.svg'),
    getAssetPath('assets/images/company-logo-1.svg')
  ]
